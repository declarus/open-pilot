...
#from common import params as para
from common.params import Params
...
def fingerprint(logcan, sendcan, has_relay):
  ...
  candidate_cars = {i: all_known_cars() for i in [0, 1, 2]}  # attempt fingerprint on both bus 0 and 1
  frame = 0
  ...
  while not done:
    ...
    # if we only have one car choice and the time since we got our firstcan_sock
...
def get_car(logcan, sendcan, has_relay=False):
  ...
  if candidate is None:
    ...
    candidate = "mock"
  #candidate = 'TOYOTA C-HR HYBRID 2018'
## 'toyota': ['LEXUS IS300 2018', 'TOYOTA C-HR HYBRID 2018', 'TOYOTA COROLLA TSS2 2019', 'TOYOTA CAMRY 2018', 'TOYOTA C-HR 2018', 
## 'TOYOTA HIGHLANDER 2017', 'TOYOTA SIENNA XLE 2018', 'LEXUS RX HYBRID 2017', 'TOYOTA RAV4 2017', 'LEXUS CT 200H 2018', 
## 'TOYOTA CAMRY HYBRID 2018', 'TOYOTA PRIUS 2017', 'TOYOTA AVALON 2016', 'TOYOTA RAV4 2019', 'TOYOTA RAV4 HYBRID 2017', 
## 'TOYOTA HIGHLANDER HYBRID 2018', 'TOYOTA COROLLA 2017', 'LEXUS ES 300H 2019']
  CarInterface, CarController = interfaces[candidate]
  print("Brand name:.............................",candidate)
  car_params = CarInterface.get_params(candidate, fingerprints, vin, has_relay)
  car_params.enableDsu = True
  car_params.enableGasInterceptor = True
  print("Candidate: ",candidate)
  print("Fingerprint: ",fingerprints)
  print("Has relay: ",has_relay)
